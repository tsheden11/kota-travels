#!/usr/bin/env bash
# Complete setup for Kota Travels redesign: icons + design tokens
# Run this on branch: feature/redesign/icons
set -euo pipefail

echo "🚀 Starting Kota Travels redesign setup..."
...
# ============================================================================
# PART 1: CREATE OPTIMIZED SVG ICONS
# ============================================================================
echo "🎨 Creating optimized SVG icons..."
...
echo "✅ Created 28 SVG icon files"

# ============================================================================
# PART 2: CREATE TAILWIND CONFIG
# ============================================================================
...
# ============================================================================
# PART 3: CREATE DESIGN TOKENS CSS
# ============================================================================
echo "🎨 Creating design tokens CSS..."

cat > src/css/design-tokens.css <<'CSS'
/* ============================================================================
   Kota Travels - Design Tokens
...
:root {
  ...
  --color-secondary-50: #E0F7F7;
  --color-secondary-100: #B3ECEB;
  --color-secondary-200: #80E0DF;
  --color-secondary-300: #4DD4D3;
  --color-secondary-400: #26CAC8;
  --color-secondary-500: #0EA5A4;
  --color-secondary-600: #0B8685;
  --color-secondary-700: #086665;
  --color-secondary-800: #054746;
  --color-secondary-900: #022726;
  ...
  /* ========================================
     Typography Tokens
     ======================================== */
  --font-family-sans: 'Outfit', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;
...
echo "✅ Created src/css/design-tokens.css"

# ============================================================================
# PART 4: CREATE ICON NUNJUCKS MACRO
# ============================================================================
echo "🎯 Creating icon macro..."
...
echo "✅ Created src/_includes/components/icon.njk"

# ============================================================================
# PART 5: CREATE USAGE DOCUMENTATION
# ============================================================================
...
git add src/css/design-tokens.css
git add src/_includes/components/icon.njk
git add src/_includes/components/ICON_README.md

git commit -m "feat: add design system - icons, tokens, and utilities

- Add 28 optimized SVG icons with currentColor support
- Add Tailwind config with design tokens
- Add CSS design tokens and variables
- Add Nunjucks icon macro for easy usage
- Add icon system documentation
- Configure Outfit font family
- Add utility classes for icon sizing"

echo ""
echo "✅ Setup complete!"
echo ""
echo "📊 Summary:"
echo "  • Created 28 SVG icons in src/images/icons/"
echo "  • Created tailwind.config.js"
echo "  • Created src/css/design-tokens.css"
echo "  • Created src/_includes/components/icon.njk"
echo "  • Created documentation in src/_includes/components/ICON_README.md"
echo "  • Committed all changes locally"
echo ""
echo "Current branch: $(git rev-parse --abbrev-ref HEAD)"
echo ""
echo "📝 Next steps:"
echo "  1. Review the commit: git log --oneline -n 3"
echo "  2. Test locally: npm run dev (or your dev command)"
echo "  3. Import design-tokens.css in your base layout"
echo "  4. When ready: git push"
echo ""